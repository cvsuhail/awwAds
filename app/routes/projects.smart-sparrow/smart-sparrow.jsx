...
import awwAds from '~/assets/AwwLogo.png';
...
const title = 'Welcome to AwwAds';
const description =
  'We’re a full-service branding and design agency passionate about helping businesses build a strong, memorable presence. Our services include logo design, social media management, poster creation, reels, and complete branding collateral.';
const roles = [
  'Branding & Stratergy',
  ...
  return (
    <>
      <ProjectContainer>
        ...
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>Creativity meets Identity.</ProjectSectionHeading>
            <ProjectSectionText>
              Beyond branding, we also operate an online gifting store offering personalized 
              products like wooden photo engravings, keychains, mugs, T-shirts, frames, and 
              more — ideal for corporate and personal gifting.
              <br></br>
              At AwwAds, we don’t just design — we craft stories, emotions, and experiences.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        ...
        {/* do on future after deploy store -------------------------------------------------------------------------------- */}
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  <ProjectSectionHeading>Aww Shop</ProjectSectionHeading>
                  <ProjectSectionText>
          ...
          <Suspense>
            ...
            >
                ...
                <ProjectSection>
                  <ProjectSectionContent>
                    <ProjectTextRow center>
                      <ProjectSectionHeading>
                      🚀 Our Mission – Branding That Leaves a Mark
                      </ProjectSectionHeading>
                      <ProjectSectionText>
                      At AwwAds, our mission is to empower businesses and individuals through impactful design and meaningful personalization. Whether it’s a brand logo or a custom-engraved gift, we aim to deliver creativity that connects, communicates, and converts.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      🌟 Our Vision – Where Creativity Meets Purpose
                      </ProjectSectionHeading>
                      <ProjectSectionText>
                      We envision a world where every brand tells a story and every gift creates a memory. AwwAds aspires to be a leading creative hub, known for its fusion of strategy, design, and innovation — helping businesses grow and people express through personalized creations.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="start" width="s">
                      <ProjectSectionHeading level={4} as="h3">
                      📈 Future Expansion – Growing Beyond the Grid
                      </ProjectSectionHeading>
                      <ProjectSectionText>
                      We’re just getting started. Here’s what’s ahead for AwwAds:
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
              ...
              <EarthSection
                ...
                meshes={['Atmosphere', 'EarthFull']}
                labels={[
                  'Mobile App for our Store',
                  'Physical Studio & Storefront',
                  'Pan-India Delivery',
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              <Image alt="" role="presentation" src={awwAds} />
